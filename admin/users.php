            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="status-<?php echo $user['active'] ? 'active' : 'inactive'; ?>"> <?php echo $user['active'] ? 'Active' : 'Inactive'; ?> </span>
                        </td>
                        ...
                        <td>
                            ...
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" class="btn <?php echo $user['active'] ? 'btn-danger' : 'btn-success'; ?>"> <?php echo $user['active'] ? 'Deactivate' : 'Activate'; ?> </button>
                            </form>
