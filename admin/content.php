    ...
    <body>
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
                ...
                <div style="font-size: 14px; color: #666; display: flex; gap: 15px; flex-wrap: wrap;"> Ingelogd als: <strong><?php echo htmlspecialchars($auth->getCurrentUser()['username']); ?></strong> (<?php echo htmlspecialchars($auth->getCurrentUser()['role']); ?>) <?php if ($auth->canViewData()): ?> <a href="data.php" style="color: #007bff; text-decoration: none;">📊 Gegevens</a> <?php endif; ?> <?php if ($auth->canManageUsers()): ?> <a href="users.php" style="color: #007bff; text-decoration: none;">👥 Gebruikers</a> <?php endif; ?> <a href="../logout.php" style="color: #dc3545; text-decoration: none;">Uitloggen</a> </div>
            </div>
            <?php if ($message): ?>
            <div class="message-box" style="color: <?php echo strpos($message, 'Error') !== false ? '#721c24' : '#155724'; ?>; background: <?php echo strpos($message, 'Error') !== false ? '#f8d7da' : '#d4edda'; ?>; border-left-color: <?php echo strpos($message, 'Error') !== false ? '#dc3545' : '#28a745'; ?>;"> <?php echo $message; ?> </div>
            <?php endif; ?>
            <div class="content-grid">
                ...
                <div class="editor-panel">
                    ...
                    <form method="POST">
                        ...
                        <div id="preview" style="border: 1px solid #ddd; padding: 10px; min-height: 100px; background: #f9f9f9; margin-top: 8px; border-radius: 4px;">
                        </div>
                            ...
                            <tr class="content-row" data-key="<?php echo htmlspecialchars($item['section_key']); ?>" data-content="<?php echo htmlspecialchars($item['content']); ?>" onclick="loadContent(this)">
                                ...
                                <td>
                                    <form method="POST" style="display: inline;" onsubmit="return confirm('Weet je zeker dat je deze sectie wilt togglen?')">
                                        ...
                                        <button type="submit" style="background: <?php echo $item['active'] ? '#28a745' : '#dc3545'; ?>; color: white; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer;"> <?php echo $item['active'] ? 'Aan' : 'Uit'; ?> </button>
                                    </form>
                                </td>
                            </tr>
                            <?php endforeach; ?>
            ...
            <div class="info">
                ...
                <ul style="margin: 10px 0; padding-left: 20px;">
                    ...
                    <li><strong>Let op!</strong> De titels van de opties (Niets doen, Buurtbatterij, Thuisbatterij) moeten tweemaal aangepast worden, zowel in 'pakket0x' als 'overzicht1x'.</li>
                </ul>
